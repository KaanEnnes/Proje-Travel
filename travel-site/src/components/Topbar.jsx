...
export default function Topbar() {
    return (
        <div className="fixed top-6 left-0 w-full flex justify-center items-center z-50 px-4" style={{ fontFamily: 'Outfit, sans-serif' }}>
            <div className="w-full max-w-5xl mx-auto bg-white/01 p-4 rounded-2xl border border-white/20 backdrop-blur-md flex justify-between items-center shadow-2xl transition-all duration-300 hover:bg-white/[0.15]">
                ...
                <div className="flex gap-8 items-center text-white/90 font-medium tracking-wide" style={{ fontFamily: 'Outfit, sans-serif' }}>
                    <ul className="flex gap-8 items-center text-white/90 font-medium tracking-wide">
